<template>
  <div class="login">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
      ...
      <el-checkbox v-model="loginForm.rememberMe" style="margin:0px 0px 25px 0px;">تذكرني</el-checkbox>
      <el-form-item style="width:100%;">
        ...
        <div style="float: left;" v-if="register">
          <router-link class="link-type" :to="'/register'">إنشاء حساب جديد</router-link>
        </div>
      </el-form-item>
    </el-form>
    <!--  Footer -->
  ...
  data() {
    return {
      ...
      loginRules: {
        ...
        code: [
          { required: true, trigger: "change", message: "يرجى إدخال رمز التحقق" }
        ]
      },
      loading: false,
      // 验证码开关
