<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="empList" @selection-change="handleSelectionChange" @row-click="goToChangePunch">
...
export default {
  ...
  methods: {
    ...
    goToChangePunch(row) {
      this.$router.push({ path: "/hr/change-punch/detail/list/" + row.id});
    },
    // 表单重置
    reset() {
      this.form = {
