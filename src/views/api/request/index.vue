<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="empList" @selection-change="handleSelectionChange" @row-click="goToRequest">
...
export default {
  ...
  methods: {
    ...
    goToRequest(row) {
      this.$router.push({ path: "/hr/request/detail/list/" + row.id});
    },
    // 表单重置
    reset() {
      this.form = {
