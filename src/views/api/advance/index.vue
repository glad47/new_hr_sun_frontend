<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="empList" @selection-change="handleSelectionChange" @row-click="goToAdvance">
...
export default {
  ...
  methods: {
    ...
    goToAdvance(row) {
      this.$router.push({ path: "/hr/advance/detail/list/" + row.id});
    },
    // 表单重置
    reset() {
      this.form = {
