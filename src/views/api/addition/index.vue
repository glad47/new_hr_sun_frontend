<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="empList" @selection-change="handleSelectionChange" @row-click="goToAddition">
...
export default {
  ...
  methods: {
    ...
    goToAddition(row) {
      this.$router.push({ path: "/hr/addition/detail/list/" + row.id});
    },
    // 表单重置
    reset() {
      this.form = {
