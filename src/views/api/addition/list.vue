<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="100px" >
      ...
      <el-form-item label="مبلغ الاضافة" prop="amount">
        <el-input
          v-model="queryParams.amount"
          placeholder="أدخل مبلغ الاضافة"
          clearable
    ...
    <div style="margin-bottom: 20px; font-size: 18px; font-weight: bold;">
          بيانات الاضافات الخاصة بالموظف: {{ employeeName || 'جارٍ التحميل...' }}
    </div>
    ...
    <el-table v-loading="loading" :data="dedectionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="معرف الاضافة" align="center" prop="id" />
      ...
      <el-table-column label="مبلغ الاضافة" align="center" prop="amount" />
      <el-table-column label="حالة الاضافة" align="center" prop="status" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body >
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="مبلغ الاضافة" prop="amount">
          <el-input v-model="form.amount" placeholder="أدخل مبلغ الاضافة" />
        </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        amount: [
          { required: true, message: "مبلغ الاضافة مطلوب", trigger: "blur" }
        ]
      }
  ...
  methods: {
    ...
    getStatusLabel(value) {
      switch (value) {
        ...
        case '1': return 'مقبولة';
        case '2': return 'مرفوضة';
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('هل أنت متأكد من حذف بيانات الاضافة بالرقم "' + ids + '"؟').then(function() {
    ...
    async handleApprove(row) {
      try {
          ...
          await updateAddition(updated); // reuse existing update function
